...
final class UsageDetailsView: NSView, NSTextFieldDelegate {
    ...
    private func layoutCostControls() {
        ...
        let summaryRows: CGFloat = 2
        let summaryY = settingsRect.maxY + 16
        let summaryHeight = summaryRows * summaryCardHeight + gap
    ...
    @objc private func showHistoricalEmptyWeeksChanged() {
        ...
        let isOn = showHistoricalEmptyWeeksButton.state == .on
        onShowHistoricalEmptyWeeksChanged?(isOn)
        hoveredCostHistoryIndex = nil
        needsDisplay = true
        needsLayout = true
    }
    ...
    func controlTextDidEndEditing(_ obj: Notification) {
        ...
        guard field === costAmountField else { return }
    ...
    private func drawCostPage(snapshot: DetailsSnapshot, content: NSRect) {
        ...
        let settingsRect = NSRect(x: content.minX, y: content.minY + 78, width: content.width, height: 252)
