...
enum L10nKey {
    ...
    var english: String {
        ...
        case .modelGroupingNote: return "Model grouping comes from local Codex rollout logs, Claude Code assistant usage entries, and OpenCode session messages."
        ...
        case .sourceSplit: return "Source split"
    ...
    var chinese: String {
        ...
        case .modelGroupingNote: return "模型分组来自本地 Codex rollout 日志、Claude Code assistant usage 记录和 OpenCode 会话消息。"
    ...
    var japanese: String {
        ...
        case .modelGroupingNote: return "モデル別集計はローカル Codex rollout ログ、Claude Code assistant usage、OpenCode セッションメッセージから取得します。"
